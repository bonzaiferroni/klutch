...
inline fun <reified Returned, E : GetEndpoint<Returned>> Route.getApi(
    endpoint: E,
    noinline block: suspend RoutingContext.(E) -> Outcome<Returned>?
) = get(endpoint.path) {
...
inline fun <reified Returned, E : GetByIdEndpoint<IdType, Returned>, IdType> Route.getApi(
    ...
    noinline block: suspend RoutingContext.(DataRequest<IdType, Returned, E>) -> Outcome<Returned>?
) = get(endpoint.serverIdTemplate) {
    val id = call.getIdOrThrow(convertId)
...
inline fun <reified Returned, E : GetByIdEndpoint<String, Returned>> Route.getApi(
    endpoint: E,
    noinline block: suspend RoutingContext.(DataRequest<String, Returned, E>) -> Outcome<Returned>?
) = get(endpoint.serverIdTemplate) {
...
inline fun <reified Returned, E : GetByIdEndpoint<Slug, Returned>> Route.getApi(
    endpoint: E,
    noinline block: suspend RoutingContext.(DataRequest<Slug, Returned, E>) -> Outcome<Returned>?
) = get(endpoint.serverIdTemplate) {
...
inline fun <reified Sent: Any, E: DeleteEndpoint<Sent>> Route.deleteApi(
    endpoint: E,
    noinline block: suspend RoutingContext.(DataRequest<Sent, Boolean, E>) -> Outcome<Boolean>?
