...
import klutch.db.services.AuthServiceLegacy
...
//) {
//    val authorizer = AuthorizerLegacy(refreshTokenService, jwtService, dao::readByUsernameOrEmail)
//    val authService = AuthServiceLegacy(dao)
...
//            outcomeOf(dao.readPrivateInfo(username.value))
//        }
//    }
//}
//
//private fun RoutingCall.appendCookies(auth: AuthLegacy) {
